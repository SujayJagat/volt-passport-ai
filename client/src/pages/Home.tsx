...
export default function Home() {
  ...
  return (
    <div className={`app-shell grade-${result.grade}`}>
      <nav className="top-nav"><Link className="wordmark" href="/"><span className="mark"><svg viewBox="0 0 21 21" width="21" height="21" xmlns="http://www.w3.org/2000/svg"><text x="10.5" y="15" fill="#00f5d4" fontFamily="monospace" fontSize="14" textAnchor="middle">V</text></svg></span><span>VOLT<span className="wordmark-muted">PASSPORT</span><b> AI</b></span></Link><div className="nav-links"><Link href="/signal">Signal</Link><Link href="/analyzer">Analyzer</Link><Link href="/explainability">Explainability</Link><Link href="/passport">Passport</Link></div><div className="nav-right" style={{ display: "flex" }}><span className="live-dot"><i/> POCKETBASE DB</span><Link className="nav-button" href="/dashboard">Open workspace <ArrowUpRight size={14}/></Link></div></nav>
    <main id="top">
